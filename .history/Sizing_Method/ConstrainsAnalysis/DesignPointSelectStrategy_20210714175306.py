...
class Design_Point_Select_Strategy:
    ...
    def __init__(self, altitude, velocity, beta, methop_turbofan_max, p_motorfun_max, n=12):
        """
    ...
    def w_s_stall_speed(self, method):
        problem = method(self.h[0], self.v[0], self.beta[0], 6000, self.hp_threshold)
