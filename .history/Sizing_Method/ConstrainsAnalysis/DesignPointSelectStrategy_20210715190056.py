...
if __name__ == "__main__":
    ...
    for z in range(3):
        ...
        design_point_w_s[z, 0], design_point_p_w[z, 4], design_point_p_w[z, 4], p_w_2_min_M, hp_p_w_min_M, p_w_turbofan_max_M, p_w_motorfun_max_M = problem1.strategy()
        design_point_w_s[z, 0], design_point_p_w[z, 5], p_w_1_min_G, p_w_2_min_G, hp_p_w_min_G, p_w_turbofan_max_G, p_w_motorfun_max_G = problem1.strategy()
