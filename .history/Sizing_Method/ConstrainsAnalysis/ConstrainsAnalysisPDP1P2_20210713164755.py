            ...
            if k <= 5:
                if i == 1:
                    ...
                    ax[k].plot(w_s, p_w[i, :, k], color=color[i],
                               linewidth=1, alpha=0.25, label=constrains_name[i])
                else:
                    ax[k].plot(w_s, p_w[i, :, k], color=color[i],
                               linewidth=1.1, alpha=0.25, label=constrains_name[i])
            else:
                if i == 1:
                    ax[k-2].plot(p_w[i, :, k], np.linspace(
                        0, 250, n), color=color[i], linewidth=1, linestyle='--', label=constrains_name[i])
                else:
