...
class ConstrainsAnalysis_Mattingly_Method_with_DP:
    ...
    def stall_speed(self, V_stall_to=65, Cl_max_to=2.32):
        ...
        w_s = ca.ConstrainsAnalysis_Mattingly_Method(self.h, self.v, self.beta, 1).stall_speed()
        self.delta_cl = ad.aerodynamics_with_pd(self.h, self.v, Hp=self.hp, n=self.n, W_S=self.w_s).delta_lift_coefficient(cl)
