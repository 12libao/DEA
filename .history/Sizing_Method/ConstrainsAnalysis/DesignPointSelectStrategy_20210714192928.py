...
class Design_Point_Select_Strategy:
    ...
    def __init__(self, altitude, velocity, beta, method, p_w_turbofan_max=72, p_w_motorfun_max, n=12):
        """
...
if __name__ == "__main__":
    ...
    problem = Design_Point_Select_Strategy(h, v, beta, method=2, p_w_turbofan_max=72, p_w_motorfun_max=72, n=12)
