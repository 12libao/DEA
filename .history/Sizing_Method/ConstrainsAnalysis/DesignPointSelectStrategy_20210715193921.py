...
if __name__ == "__main__":
    ...
    lablel_1 = ['hp: 0.5', 'hp: adjust', 'hp: adjust with threshold']
    lablel_2 = ['design point hp: 0.5', 'design point hp: adjust', 'design point hp: adjust with threshold']
    ...
    for z in range(3):
        ...
        for k in range(6):
            ...
            ax[k].fill_between(w_s, np.amax(p_w[0:m, :, k], axis=0), 150, color=color2[z], alpha=0.5, label=lablel1[z])
