    ...
    def strategy(self):
        if self.strategy_apply == 0:
            ...
            p_w, p_w_1, p_w_2 = Design_Point_Select_Strategy.p_w_compute(
                self, p_w_turbofan_max=10000, p_w_motorfun_max=10000)
            p_w_min = p_w[:, 50]
            p_w_turbofan_max = p_w_1[:, 50]
            p_w_motorfun_max = p_w_2[:, 50]
            p_w_turbofan_max = np.array([self.w_s, np.amax(p_w_turbofan_max)])
            p_w_motorfun_max = np.array([self.w_s, np.amax(p_w_motorfun_max)])
            ...
            p_w = Design_Point_Select_Strategy.p_w_compute(
        ...
        return hp_p_w_min, design_point, p_w_1, p_w_2, p_w_turbofan_max, p_w_motorfun_max
...
if __name__ == "__main__":
    ...
    hp_p_w_min, design_point, p_w_turbofan_max, p_w_motorfun_max = problem.strategy()
    ic(hp_p_w_min, design_point, p_w_turbofan_max, p_w_motorfun_max)
