...
class Design_Point_Select_Strategy:
    ...
    def __init__(self, altitude, velocity, beta, method, p_w_turbofan_max=1, p_w_motorfun_max=30, n=12):
        """
...
if __name__ == "__main__":
    ...
    methods = [ca_pd_12ConstrainsAnalysis_Mattingly_Method_with_DP_turbofun,
