...
if __name__ == "__main__":
    ...
    for z in range(3):
        ...
        if z == 0:
            problem1 = Design_Point_Select_Strategy(h, v, beta, method=1, strategy_apply=1, propulsion_constrains=0)
            problem2 = Design_Point_Select_Strategy(h, v, beta, method=1, strategy_apply=1, propulsion_constrains=0)
