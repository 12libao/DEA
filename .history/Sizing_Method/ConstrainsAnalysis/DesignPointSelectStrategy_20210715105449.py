...
class Design_Point_Select_Strategy:
    ...
    def __init__(self, altitude, velocity, beta, method=1, strategy_apply=0, propulsion_constrains=0, n=12):
        ...
        :param propulsion_constrains: if propulsion_constrains = 0, no propulsion_constrains 
    ...
    def p_w_compute(self, p_w_turbofan_max, p_w_motorfun_max):
        ...
        for i in range(1, 8):
            for j in range(len(self.hp)):
                ...
                if p_w_1 > p_w_turbofan_max:
                        p_w_1 = 100000
                elif p_w_2 > p_w_motorfun_max:
                        p_w_2 = 100000
...
if __name__ == "__main__":
    ...
    problem = Design_Point_Select_Strategy(h, v, beta, method=1)
