...
class ConstrainsAnalysis_Mattingly_Method:
    ...
    def __init__(self, altitude, velocity, beta, wing_load, Hp=0.5, C_DR=0):
        """
        ...
        self.coeff = (1-self.hp=Hp)self.beta / self.alpha
...
class ConstrainsAnalysis_Gudmundsson_Method:
    ...
    def __init__(self, altitude, velocity, beta, wing_load, Hp=0.5, e=0.75, AR=10.3):
        """
