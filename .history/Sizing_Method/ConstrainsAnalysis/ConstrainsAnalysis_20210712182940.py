...
class ConstrainsAnalysis_Mattingly_Method:
    ...
    def __init__(self, altitude, velocity, beta, wing_load, Hp=0.2, C_DR=0):
        """
...
class ConstrainsAnalysis_Gudmundsson_Method:
    ...
    def __init__(self, altitude, velocity, beta, wing_load, Hp=0.2, e=0.75, AR=10.3):
        """
