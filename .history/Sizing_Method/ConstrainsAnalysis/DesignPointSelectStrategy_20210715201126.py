...
if __name__ == "__main__":
    ...
    for z in range(3):
        ...
        w_s1, p_w_min11, p_w_1_min, p_w_2_min, hp_p_w_min, p_w_turbofan_max, p_w_motorfun_max = problem1.strategy()
        ic(w_s1, p_w_min, p_w_1_min, p_w_2_min, hp_p_w_min, p_w_turbofan_max, p_w_motorfun_max )
