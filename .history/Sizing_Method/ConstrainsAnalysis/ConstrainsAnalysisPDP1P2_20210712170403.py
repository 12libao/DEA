...
if __name__ == "__main__":
    ...
    plt.setp(ax[0, 0], ylabel='Turbofun Power-to-Load: $P_{SL}$/$W_{TO}$ (W/N)')
    plt.setp(ax[1, 0], ylabel='Motor Power-to-Load: $P_{SL}$/$W_{TO}$ (W/N)')
    plt.setp(ax[2, 0], ylabel='Total Power-to-Load: $P_{SL}$/$W_{TO}$ (W/N)')
    plt.setp(ax[3, 0], ylabel='Total Power-to-Load: $P_{SL}$/$W_{TO}$ (W/N)')
    plt.show()
